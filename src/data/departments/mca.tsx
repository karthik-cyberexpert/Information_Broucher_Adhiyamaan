...
const mca: DepartmentContent = {
    about: (
        <>
            <p>
                The Department of Computer Applications, established in 1995–1996, offers a prestigious MCA program affiliated to Anna University, with an approved intake of 60 students. Accredited by the National Board of Accreditation (NBA),
