...
const ece: DepartmentContent = {
    about: (
        <>
        <p>
            The Department of Electronics and Communication Engineering at Adhiyamaan College of Engineering is committed to academic excellence, innovation, and research-driven education. The B.E.-ECE programme focuses on building strong theoretical knowledge combined with practical exposure to modern electronics, communication, embedded systems, VLSI, and emerging technologies.
    ...
    infrastructure: {
        items: [
            ...
            },
            {
                ...
                icon: '💻',
                image: '/images/be/ece/acadamic and teaching 6.jfif'
            },
            {
                title: 'Student Support Infrastructure',
                description: 'Project laboratories and Technical club room',
                icon: '💻',
                image: '/images/be/ece/student support infrastructure 7.jfif'
            }
        ]
    },
    contact: {
        ...
        location: "Department of Electronics and Communication Engineering, Main Block Adhiyamaan College of Engineering, Dr. M.G.R Nagar, Hosur – 635130, Krishnagiri District, Tamil Nadu, India",
